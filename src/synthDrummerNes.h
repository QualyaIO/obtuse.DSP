...
#ifndef SYNTHDRUMMERNES_H
#define SYNTHDRUMMERNES_H
#include <stdint.h>
#include <math.h>
#include "vultin.h"
#include "synthDrummerNes.tables.h"
...
static_inline fix16_t synthDrummerNes_Util_tonesToCoeff(fix16_t semitones){
   fix16_t log_base;
   log_base = 0xb172 /* 0.693147 */;
   return fix_exp(fix_mul(fix_mul(0x1555 /* 0.083333 */,log_base),semitones));
}

typedef struct synthDrummerNes_Util__ctx_type_2 {
   uint8_t pre;
} synthDrummerNes_Util__ctx_type_2;

typedef synthDrummerNes_Util__ctx_type_2 synthDrummerNes_Util_edge_type;

static_inline void synthDrummerNes_Util__ctx_type_2_init(synthDrummerNes_Util__ctx_type_2 &_output_){
   synthDrummerNes_Util__ctx_type_2 &_ctx = _output_;
   _ctx.pre = false;
   
   return ;
}

static_inline void synthDrummerNes_Util_edge_init(synthDrummerNes_Util__ctx_type_2 &_output_){
   synthDrummerNes_Util__ctx_type_2_init(_output_);
   return ;
}

static_inline uint8_t synthDrummerNes_Util_edge(synthDrummerNes_Util__ctx_type_2 &_ctx, uint8_t x){
   uint8_t ret;
...
typedef synthDrummerNes_Util__ctx_type_4 synthDrummerNes_Util_change_type;

static_inline void synthDrummerNes_Util__ctx_type_4_init(synthDrummerNes_Util__ctx_type_4 &_output_){
   synthDrummerNes_Util__ctx_type_4 &_ctx = _output_;
   _ctx.pre_x = 0x0 /* 0.000000 */;
   
   return ;
}

static_inline void synthDrummerNes_Util_change_init(synthDrummerNes_Util__ctx_type_4 &_output_){
   synthDrummerNes_Util__ctx_type_4_init(_output_);
   return ;
}

static_inline uint8_t synthDrummerNes_Util_change(synthDrummerNes_Util__ctx_type_4 &_ctx, fix16_t x){
   uint8_t v;
   v = (_ctx.pre_x != x);
   _ctx.pre_x = x;
   return v;
...
typedef struct synthDrummerNes_Util__ctx_type_5 {
   fix16_t x;
} synthDrummerNes_Util__ctx_type_5;

typedef synthDrummerNes_Util__ctx_type_5 synthDrummerNes_Util_smooth_type;

static_inline void synthDrummerNes_Util__ctx_type_5_init(synthDrummerNes_Util__ctx_type_5 &_output_){
   synthDrummerNes_Util__ctx_type_5 &_ctx = _output_;
   _ctx.x = 0x0 /* 0.000000 */;
   
   return ;
}

static_inline void synthDrummerNes_Util_smooth_init(synthDrummerNes_Util__ctx_type_5 &_output_){
   synthDrummerNes_Util__ctx_type_5_init(_output_);
   return ;
}

static_inline fix16_t synthDrummerNes_Util_smooth(synthDrummerNes_Util__ctx_type_5 &_ctx, fix16_t input, fix16_t coeff){
...
static_inline void synthDrummerNes_Buffer_buffer(fix16_t (&oBuff)[128]){
}

void synthDrummerNes_Buffer_buffer_large(fix16_t (&oBuff)[2048]);

static_inline int synthDrummerNes_Buffer_bufferSize(){
   return 128;
};

static_inline int synthDrummerNes_Buffer_bufferLargeSize(){
   return 2048;
};
...
static_inline void synthDrummerNes_Drummer_updateStep(synthDrummerNes_Drummer__ctx_type_0 &_ctx){
   ...
   if(_ctx.bend != 0x0 /* 0.000000 */){
      _ctx.step = fix_mul(_ctx.step,synthDrummerNes_Util_tonesToCoeff(_ctx.bend));
   }
}

typedef synthDrummerNes_Drummer__ctx_type_0 synthDrummerNes_Drummer_pitchBend_type;

static_inline void synthDrummerNes_Drummer_pitchBend_init(synthDrummerNes_Drummer__ctx_type_0 &_output_){
   synthDrummerNes_Drummer__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthDrummerNes_Drummer_pitchBend(synthDrummerNes_Drummer__ctx_type_0 &_ctx, fix16_t semitones){
...
typedef synthDrummerNes_Drummer__ctx_type_0 synthDrummerNes_Drummer_setNote_type;

static_inline void synthDrummerNes_Drummer_setNote_init(synthDrummerNes_Drummer__ctx_type_0 &_output_){
   synthDrummerNes_Drummer__ctx_type_0_init(_output_);
   return ;
}
...
typedef synthDrummerNes_Drummer__ctx_type_0 synthDrummerNes_Drummer_nbHeldNotes_type;

static_inline void synthDrummerNes_Drummer_nbHeldNotes_init(synthDrummerNes_Drummer__ctx_type_0 &_output_){
   synthDrummerNes_Drummer__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthDrummerNes_Drummer_nbHeldNotes(synthDrummerNes_Drummer__ctx_type_0 &_ctx){
   if(_ctx.slice < 0){
      return 0;
   }
   return 1;
...
static_inline void synthDrummerNes_Drummer__ctx_type_1_init(synthDrummerNes_Drummer__ctx_type_1 &_output_){
   synthDrummerNes_Drummer__ctx_type_1 &_ctx = _output_;
...
static_inline void synthDrummerNes_Poly_runVoice(synthDrummerNes_Poly__ctx_type_0 &_ctx, int voice, int nb, fix16_t (&buff)[128]){
   switch(voice) {
      case 0:
...
typedef synthDrummerNes_Poly__ctx_type_0 synthDrummerNes_Poly_synthPitchBend_type;

static_inline void synthDrummerNes_Poly_synthPitchBend_init(synthDrummerNes_Poly__ctx_type_0 &_output_){
   synthDrummerNes_Poly__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthDrummerNes_Poly_synthPitchBend(synthDrummerNes_Poly__ctx_type_0 &_ctx, fix16_t semitones){
   synthDrummerNes_Drummer_pitchBend(_ctx.voice0,semitones);
   synthDrummerNes_Drummer_pitchBend(_ctx.voice1,semitones);
   synthDrummerNes_Drummer_pitchBend(_ctx.voice2,semitones);
   synthDrummerNes_Drummer_pitchBend(_ctx.voice3,semitones);
}
...
typedef synthDrummerNes_Poly__ctx_type_0 synthDrummerNes_Poly_synthGetLoop_type;

static_inline void synthDrummerNes_Poly_synthGetLoop_init(synthDrummerNes_Poly__ctx_type_0 &_output_){
   synthDrummerNes_Poly__ctx_type_0_init(_output_);
   return ;
}

static_inline uint8_t synthDrummerNes_Poly_synthGetLoop(synthDrummerNes_Poly__ctx_type_0 &_ctx){
   return false;
};

typedef synthDrummerNes_Poly__ctx_type_0 synthDrummerNes_Poly_synthGetLoopStart_type;

static_inline void synthDrummerNes_Poly_synthGetLoopStart_init(synthDrummerNes_Poly__ctx_type_0 &_output_){
   synthDrummerNes_Poly__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthDrummerNes_Poly_synthGetLoopStart(synthDrummerNes_Poly__ctx_type_0 &_ctx){
   return 0;
};

typedef synthDrummerNes_Poly__ctx_type_0 synthDrummerNes_Poly_synthGetLoopEnd_type;

static_inline void synthDrummerNes_Poly_synthGetLoopEnd_init(synthDrummerNes_Poly__ctx_type_0 &_output_){
   synthDrummerNes_Poly__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthDrummerNes_Poly_synthGetLoopEnd(synthDrummerNes_Poly__ctx_type_0 &_ctx){
   return 0;
};
...
typedef synthDrummerNes_Poly__ctx_type_0 synthDrummerNes_Poly_synthSetEnvDecimationFactor_type;

static_inline void synthDrummerNes_Poly_synthSetEnvDecimationFactor_init(synthDrummerNes_Poly__ctx_type_0 &_output_){
   synthDrummerNes_Poly__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthDrummerNes_Poly_synthSetEnvDecimationFactor(synthDrummerNes_Poly__ctx_type_0 &_ctx, int newFactor){
}
...
static_inline void synthDrummerNes_Poly__ctx_type_1_init(synthDrummerNes_Poly__ctx_type_1 &_output_){
   synthDrummerNes_Poly__ctx_type_1 &_ctx = _output_;
...
typedef synthDrummerNes_Voice__ctx_type_0 synthDrummerNes_Voice_nbActiveVoices_type;

static_inline void synthDrummerNes_Voice_nbActiveVoices_init(synthDrummerNes_Voice__ctx_type_0 &_output_){
   synthDrummerNes_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthDrummerNes_Voice_nbActiveVoices(synthDrummerNes_Voice__ctx_type_0 &_ctx){
   return synthDrummerNes_Notes_nbNotes(_ctx.voicesactive);
};
...
typedef synthDrummerNes_Voice__ctx_type_0 synthDrummerNes_Voice_synthPitchBend_type;

static_inline void synthDrummerNes_Voice_synthPitchBend_init(synthDrummerNes_Voice__ctx_type_0 &_output_){
   synthDrummerNes_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthDrummerNes_Voice_synthPitchBend(synthDrummerNes_Voice__ctx_type_0 &_ctx, fix16_t semitones){
   synthDrummerNes_Poly_synthPitchBend(_ctx.poly,semitones);
};
...
typedef synthDrummerNes_Voice__ctx_type_0 synthDrummerNes_Voice_synthGetLoop_type;

static_inline void synthDrummerNes_Voice_synthGetLoop_init(synthDrummerNes_Voice__ctx_type_0 &_output_){
   synthDrummerNes_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline uint8_t synthDrummerNes_Voice_synthGetLoop(synthDrummerNes_Voice__ctx_type_0 &_ctx){
   return synthDrummerNes_Poly_synthGetLoop(_ctx.poly);
};

typedef synthDrummerNes_Voice__ctx_type_0 synthDrummerNes_Voice_synthGetLoopStart_type;

static_inline void synthDrummerNes_Voice_synthGetLoopStart_init(synthDrummerNes_Voice__ctx_type_0 &_output_){
   synthDrummerNes_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthDrummerNes_Voice_synthGetLoopStart(synthDrummerNes_Voice__ctx_type_0 &_ctx){
   return synthDrummerNes_Poly_synthGetLoopStart(_ctx.poly);
};

typedef synthDrummerNes_Voice__ctx_type_0 synthDrummerNes_Voice_synthGetLoopEnd_type;

static_inline void synthDrummerNes_Voice_synthGetLoopEnd_init(synthDrummerNes_Voice__ctx_type_0 &_output_){
   synthDrummerNes_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthDrummerNes_Voice_synthGetLoopEnd(synthDrummerNes_Voice__ctx_type_0 &_ctx){
   return synthDrummerNes_Poly_synthGetLoopEnd(_ctx.poly);
};
...
typedef synthDrummerNes_Voice__ctx_type_0 synthDrummerNes_Voice_synthSetEnvDecimationFactor_type;

static_inline void synthDrummerNes_Voice_synthSetEnvDecimationFactor_init(synthDrummerNes_Voice__ctx_type_0 &_output_){
   synthDrummerNes_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthDrummerNes_Voice_synthSetEnvDecimationFactor(synthDrummerNes_Voice__ctx_type_0 &_ctx, int newFactor){
   synthDrummerNes_Poly_synthSetEnvDecimationFactor(_ctx.poly,newFactor);
};
...
static_inline void synthDrummerNes_Voice__ctx_type_1_init(synthDrummerNes_Voice__ctx_type_1 &_output_){
   synthDrummerNes_Voice__ctx_type_1 &_ctx = _output_;
   synthDrummerNes_Voice__ctx_type_0_init(_ctx._inst1b9);
