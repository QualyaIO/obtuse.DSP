...
void synthDrummerNes_Drummer_default(synthDrummerNes_Drummer__ctx_type_0 &_ctx){
   ...
   synthDrummerNes_Drummer_setSlices(_ctx,{0,7000,14850,28000,43900,48000,57200,66600,68900,73300,85000,94500
   },{6250,14000,26800,43400,47950,56900,66000,68500,72400,84600,94000,103500
   });
...
void synthDrummerNes_Voice_process_bufferTo_alt(synthDrummerNes_Voice__ctx_type_0 &_ctx, int nb, fix16_t (&oBuffer)[256]){
   ...
   synthDrummerNes_Poly_runVoice(_ctx.poly,0,nb,_ctx.buffer_v0);
   synthDrummerNes_Poly_runVoice(_ctx.poly,1,nb,_ctx.buffer_v1);
   synthDrummerNes_Poly_runVoice(_ctx.poly,2,nb,_ctx.buffer_v2);
   synthDrummerNes_Poly_runVoice(_ctx.poly,3,nb,_ctx.buffer_v3);
   if(nb > 0){
...
void synthDrummerNes_Voice_default(synthDrummerNes_Voice__ctx_type_0 &_ctx){
   ...
   synthDrummerNes_Buffer_buffer(_ctx.buffer_v1);
   synthDrummerNes_Buffer_buffer(_ctx.buffer_v2);
   synthDrummerNes_Buffer_buffer(_ctx.buffer_v3);
   if(_ctx.number_voices == 0){
...
void synthDrummerNes_Voice__ctx_type_1_init(synthDrummerNes_Voice__ctx_type_1 &_output_){
   ...
   synthDrummerNes_Voice__ctx_type_0_init(_ctx._inst275);
