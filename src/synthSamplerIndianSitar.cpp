...
void synthSamplerIndianSitar_Notes__ctx_type_0_init(synthSamplerIndianSitar_Notes__ctx_type_0 &_output_){
   synthSamplerIndianSitar_Notes__ctx_type_0 &_ctx = _output_;
   _ctx.poly = false;
...
void synthSamplerIndianSitar_Sampler__ctx_type_0_init(synthSamplerIndianSitar_Sampler__ctx_type_0 &_output_){
   synthSamplerIndianSitar_Sampler__ctx_type_0 &_ctx = _output_;
...
void synthSamplerIndianSitar_Sampler_noteOn(synthSamplerIndianSitar_Sampler__ctx_type_0 &_ctx, int note, int velocity, int channel){
   note = int_clip(note,0,127);
   if(synthSamplerIndianSitar_Notes_noteOn(_ctx.playingnotes,note,velocity,channel)){
...
void synthSamplerIndianSitar_Sampler_default(synthSamplerIndianSitar_Sampler__ctx_type_0 &_ctx){
   ...
   synthSamplerIndianSitar_Buffer_buffer(_ctx.buffer_cross);
   _ctx.crossfade = false;
...
void synthSamplerIndianSitar_Poly__ctx_type_0_init(synthSamplerIndianSitar_Poly__ctx_type_0 &_output_){
   synthSamplerIndianSitar_Poly__ctx_type_0 &_ctx = _output_;
...
void synthSamplerIndianSitar_Voice__ctx_type_0_init(synthSamplerIndianSitar_Voice__ctx_type_0 &_output_){
   synthSamplerIndianSitar_Voice__ctx_type_0 &_ctx = _output_;
...
void synthSamplerIndianSitar_Voice_process_bufferTo_alt(synthSamplerIndianSitar_Voice__ctx_type_0 &_ctx, int nb, fix16_t (&oBuffer)[256]){
   ...
   synthSamplerIndianSitar_Poly_runVoice(_ctx.poly,0,nb,_ctx.buffer_v0);
   synthSamplerIndianSitar_Poly_runVoice(_ctx.poly,1,nb,_ctx.buffer_v1);
   synthSamplerIndianSitar_Poly_runVoice(_ctx.poly,2,nb,_ctx.buffer_v2);
   synthSamplerIndianSitar_Poly_runVoice(_ctx.poly,3,nb,_ctx.buffer_v3);
   if(nb > 0){
...
void synthSamplerIndianSitar_Voice_noteOn(synthSamplerIndianSitar_Voice__ctx_type_0 &_ctx, int note, int velocity, int channel){
   ...
   if(_ctx.notes[note] <= 0){
      ...
      v = synthSamplerIndianSitar_Notes_firstNote(_ctx.voicesinactive);
      if((v > 0) && (v <= _ctx.number_voices)){
         if(synthSamplerIndianSitar_Notes_noteOff(_ctx.voicesinactive,((-1) + v),0) && synthSamplerIndianSitar_Notes_noteOn(_ctx.voicesactive,((-1) + v),127,0)){
...
void synthSamplerIndianSitar_Voice_default(synthSamplerIndianSitar_Voice__ctx_type_0 &_ctx){
   ...
   synthSamplerIndianSitar_Buffer_buffer(_ctx.buffer_v1);
   synthSamplerIndianSitar_Buffer_buffer(_ctx.buffer_v2);
   synthSamplerIndianSitar_Buffer_buffer(_ctx.buffer_v3);
   if(_ctx.number_voices == 0){
...
void synthSamplerIndianSitar_Voice__ctx_type_1_init(synthSamplerIndianSitar_Voice__ctx_type_1 &_output_){
   ...
   synthSamplerIndianSitar_Voice__ctx_type_0_init(_ctx._inst275);
