...
void synthSamplerKoto_Notes__ctx_type_0_init(synthSamplerKoto_Notes__ctx_type_0 &_output_){
   synthSamplerKoto_Notes__ctx_type_0 &_ctx = _output_;
   _ctx.poly = false;
...
void synthSamplerKoto_Sampler__ctx_type_0_init(synthSamplerKoto_Sampler__ctx_type_0 &_output_){
   synthSamplerKoto_Sampler__ctx_type_0 &_ctx = _output_;
...
void synthSamplerKoto_Sampler_noteOn(synthSamplerKoto_Sampler__ctx_type_0 &_ctx, int note, int velocity, int channel){
   note = int_clip(note,0,127);
   if(synthSamplerKoto_Notes_noteOn(_ctx.playingnotes,note,velocity,channel)){
...
void synthSamplerKoto_Sampler_default(synthSamplerKoto_Sampler__ctx_type_0 &_ctx){
   ...
   synthSamplerKoto_Buffer_buffer(_ctx.buffer_cross);
   _ctx.crossfade = false;
...
void synthSamplerKoto_Poly__ctx_type_0_init(synthSamplerKoto_Poly__ctx_type_0 &_output_){
   synthSamplerKoto_Poly__ctx_type_0 &_ctx = _output_;
...
void synthSamplerKoto_Voice__ctx_type_0_init(synthSamplerKoto_Voice__ctx_type_0 &_output_){
   synthSamplerKoto_Voice__ctx_type_0 &_ctx = _output_;
...
void synthSamplerKoto_Voice_process_bufferTo_alt(synthSamplerKoto_Voice__ctx_type_0 &_ctx, int nb, fix16_t (&oBuffer)[256]){
   ...
   synthSamplerKoto_Poly_runVoice(_ctx.poly,0,nb,_ctx.buffer_v0);
   synthSamplerKoto_Poly_runVoice(_ctx.poly,1,nb,_ctx.buffer_v1);
   synthSamplerKoto_Poly_runVoice(_ctx.poly,2,nb,_ctx.buffer_v2);
   synthSamplerKoto_Poly_runVoice(_ctx.poly,3,nb,_ctx.buffer_v3);
   if(nb > 0){
...
void synthSamplerKoto_Voice_noteOn(synthSamplerKoto_Voice__ctx_type_0 &_ctx, int note, int velocity, int channel){
   ...
   if(_ctx.notes[note] <= 0){
      ...
      v = synthSamplerKoto_Notes_firstNote(_ctx.voicesinactive);
      if((v > 0) && (v <= _ctx.number_voices)){
         if(synthSamplerKoto_Notes_noteOff(_ctx.voicesinactive,((-1) + v),0) && synthSamplerKoto_Notes_noteOn(_ctx.voicesactive,((-1) + v),127,0)){
...
void synthSamplerKoto_Voice_default(synthSamplerKoto_Voice__ctx_type_0 &_ctx){
   ...
   synthSamplerKoto_Buffer_buffer(_ctx.buffer_v1);
   synthSamplerKoto_Buffer_buffer(_ctx.buffer_v2);
   synthSamplerKoto_Buffer_buffer(_ctx.buffer_v3);
   if(_ctx.number_voices == 0){
...
void synthSamplerKoto_Voice__ctx_type_1_init(synthSamplerKoto_Voice__ctx_type_1 &_output_){
   ...
   synthSamplerKoto_Voice__ctx_type_0_init(_ctx._inst275);
