...
#ifndef SYNTHSAMPLERGLASSMARIMBASOFT_H
#define SYNTHSAMPLERGLASSMARIMBASOFT_H
#include <stdint.h>
#include <math.h>
#include "vultin.h"
#include "synthSamplerGlassMarimbaSoft.tables.h"
...
static_inline void synthSamplerGlassMarimbaSoft_Util__ctx_type_2_init(synthSamplerGlassMarimbaSoft_Util__ctx_type_2 &_output_){
   synthSamplerGlassMarimbaSoft_Util__ctx_type_2 &_ctx = _output_;
   _ctx.pre = false;
...
static_inline void synthSamplerGlassMarimbaSoft_Util__ctx_type_4_init(synthSamplerGlassMarimbaSoft_Util__ctx_type_4 &_output_){
   synthSamplerGlassMarimbaSoft_Util__ctx_type_4 &_ctx = _output_;
...
static_inline void synthSamplerGlassMarimbaSoft_Util__ctx_type_5_init(synthSamplerGlassMarimbaSoft_Util__ctx_type_5 &_output_){
   synthSamplerGlassMarimbaSoft_Util__ctx_type_5 &_ctx = _output_;
   _ctx.x = 0x0 /* 0.000000 */;
...
static_inline void synthSamplerGlassMarimbaSoft_Buffer_buffer(fix16_t (&oBuff)[128]){
}

void synthSamplerGlassMarimbaSoft_Buffer_buffer_large(fix16_t (&oBuff)[2048]);

static_inline int synthSamplerGlassMarimbaSoft_Buffer_bufferSize(){
   return 128;
};

static_inline int synthSamplerGlassMarimbaSoft_Buffer_bufferLargeSize(){
   return 2048;
};
...
typedef synthSamplerGlassMarimbaSoft_Sampler__ctx_type_0 synthSamplerGlassMarimbaSoft_Sampler_nbHeldNotes_type;

static_inline void synthSamplerGlassMarimbaSoft_Sampler_nbHeldNotes_init(synthSamplerGlassMarimbaSoft_Sampler__ctx_type_0 &_output_){
   synthSamplerGlassMarimbaSoft_Sampler__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthSamplerGlassMarimbaSoft_Sampler_nbHeldNotes(synthSamplerGlassMarimbaSoft_Sampler__ctx_type_0 &_ctx){
   return synthSamplerGlassMarimbaSoft_Notes_nbNotes(_ctx.playingnotes);
};
...
static_inline void synthSamplerGlassMarimbaSoft_Sampler__ctx_type_1_init(synthSamplerGlassMarimbaSoft_Sampler__ctx_type_1 &_output_){
   synthSamplerGlassMarimbaSoft_Sampler__ctx_type_1 &_ctx = _output_;
...
static_inline void synthSamplerGlassMarimbaSoft_Poly_runVoice(synthSamplerGlassMarimbaSoft_Poly__ctx_type_0 &_ctx, int voice, int nb, fix16_t (&buff)[128]){
   switch(voice) {
      case 0:
...
typedef synthSamplerGlassMarimbaSoft_Poly__ctx_type_0 synthSamplerGlassMarimbaSoft_Poly_synthSetEnvDecimationFactor_type;

static_inline void synthSamplerGlassMarimbaSoft_Poly_synthSetEnvDecimationFactor_init(synthSamplerGlassMarimbaSoft_Poly__ctx_type_0 &_output_){
   synthSamplerGlassMarimbaSoft_Poly__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthSamplerGlassMarimbaSoft_Poly_synthSetEnvDecimationFactor(synthSamplerGlassMarimbaSoft_Poly__ctx_type_0 &_ctx, int newFactor){
}
...
static_inline void synthSamplerGlassMarimbaSoft_Poly__ctx_type_1_init(synthSamplerGlassMarimbaSoft_Poly__ctx_type_1 &_output_){
   synthSamplerGlassMarimbaSoft_Poly__ctx_type_1 &_ctx = _output_;
...
typedef synthSamplerGlassMarimbaSoft_Voice__ctx_type_0 synthSamplerGlassMarimbaSoft_Voice_nbActiveVoices_type;

static_inline void synthSamplerGlassMarimbaSoft_Voice_nbActiveVoices_init(synthSamplerGlassMarimbaSoft_Voice__ctx_type_0 &_output_){
   synthSamplerGlassMarimbaSoft_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthSamplerGlassMarimbaSoft_Voice_nbActiveVoices(synthSamplerGlassMarimbaSoft_Voice__ctx_type_0 &_ctx){
   return synthSamplerGlassMarimbaSoft_Notes_nbNotes(_ctx.voicesactive);
};
...
typedef synthSamplerGlassMarimbaSoft_Voice__ctx_type_0 synthSamplerGlassMarimbaSoft_Voice_synthSetEnvDecimationFactor_type;

static_inline void synthSamplerGlassMarimbaSoft_Voice_synthSetEnvDecimationFactor_init(synthSamplerGlassMarimbaSoft_Voice__ctx_type_0 &_output_){
   synthSamplerGlassMarimbaSoft_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthSamplerGlassMarimbaSoft_Voice_synthSetEnvDecimationFactor(synthSamplerGlassMarimbaSoft_Voice__ctx_type_0 &_ctx, int newFactor){
   synthSamplerGlassMarimbaSoft_Poly_synthSetEnvDecimationFactor(_ctx.poly,newFactor);
};
...
static_inline void synthSamplerGlassMarimbaSoft_Voice__ctx_type_1_init(synthSamplerGlassMarimbaSoft_Voice__ctx_type_1 &_output_){
...
#endif // SYNTHSAMPLERGLASSMARIMBASOFT_H
