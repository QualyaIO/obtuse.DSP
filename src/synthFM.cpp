...
void synthFM_Wavetable_getRandomMorph(synthFM_Wavetable__ctx_type_20 &_ctx, fix16_t (&oBuff)[4096]){
   ...
   basetable = 0;
   if(8 > 1){
      basetable = (synthFM_Random_irandom(_ctx.rando) % 7);
   }
   fix16_t wavetableIdx;
   wavetableIdx = (synthFM_Random_random(_ctx.rando) + int_to_fix(basetable));
...
void synthFM_Wavetable__ctx_type_21_init(synthFM_Wavetable__ctx_type_21 &_output_){
   synthFM_Wavetable__ctx_type_21 &_ctx = _output_;
   synthFM_Random__ctx_type_0_init(_ctx._inst345);
   synthFM_Wavetable__ctx_type_20_init(_ctx._inst1c8);
   
   return ;
}

fix16_t synthFM_Wavetable_getRandRandomMorph(synthFM_Wavetable__ctx_type_21 &_ctx, fix16_t (&oBuff)[4096]){
   synthFM_Wavetable_getRandomMorph(_ctx._inst1c8,oBuff);
   int idx;
   idx = 0;
   if(4096 > 0){
      idx = (synthFM_Random_irandom(_ctx._inst345) % 4096);
   }
...
void synthFM_ADSR__ctx_type_10_init(synthFM_ADSR__ctx_type_10 &_output_){
   synthFM_ADSR__ctx_type_10 &_ctx = _output_;
   ...
   _ctx.a = 0x0 /* 0.000000 */;
   synthFM_ADSR__ctx_type_5_init(_ctx._inst61d6);
   synthFM_ADSR__ctx_type_0_init(_ctx._inst6073);
   synthFM_ADSR__ctx_type_5_init(_ctx._inst43d6);
   synthFM_Util__ctx_type_2_init(_ctx._inst251);
   synthFM_Util__ctx_type_2_init(_ctx._inst2251);
...
fix16_t synthFM_ADSR_process(synthFM_ADSR__ctx_type_10 &_ctx, uint8_t bgate){
   ...
   if(synthFM_Util_edge(_ctx._inst251,bgate) || _ctx.retrigger){
      _ctx.state = 1;
   ...
   else
   {
      ...
      if(_ctx.state == 1){
         ...
         if(bool_not(bgate)){
            _ctx.step = synthFM_ADSR_stepToRelease(_ctx,fix_mul(fix_mul(_ctx.level,_ctx.out),scale_i));
            _ctx.target = 0x0 /* 0.000000 */;
            _ctx.state = 4;
         }
      }
...
uint8_t synthFM_ADSR_process_bufferTo(synthFM_ADSR__ctx_type_10 &_ctx, uint8_t bgate, int nb, fix16_t (&oBuffer)[128]){
   ...
   int i;
   i = 0;
   if(synthFM_Util_edge(_ctx._inst2251,bgate) || _ctx.retrigger){
      _ctx.state = 1;
      _ctx.target = fix_mul(_ctx.a_target,scale);
      _ctx.step = _ctx.a_step;
      _ctx.retrigger = false;
...
void synthFM_ADSR_updateSteps(synthFM_ADSR__ctx_type_10 &_ctx){
   ...
   fix16_t min_d;
   fix16_t min_r;
   synthFM_ADSR_getMinValues(_ctx._inst43d6);
   min_a = synthFM_ADSR_getMinValues_ret_0(_ctx._inst43d6);
   min_d = synthFM_ADSR_getMinValues_ret_1(_ctx._inst43d6);
   synthFM_ADSR_getMinValues_ret_2(_ctx._inst43d6);
   min_r = synthFM_ADSR_getMinValues_ret_3(_ctx._inst43d6);
   fix16_t divider;
...
void synthFM_ADSR_setSamplerate(synthFM_ADSR__ctx_type_10 &_ctx, fix16_t newFs){
   if(newFs > 0x0 /* 0.000000 */){
      _ctx.real_fs = newFs;
   }
   ...
   synthFM_ADSR_updateLevelStep(_ctx);
}

void synthFM_ADSR_setLevel(synthFM_ADSR__ctx_type_10 &_ctx, fix16_t newLevel){
...
void synthFM_ADSR_config(synthFM_ADSR__ctx_type_10 &_ctx, fix16_t newA, fix16_t newD, fix16_t newS, fix16_t newR){
   ...
   fix16_t max_s;
   fix16_t max_r;
   synthFM_ADSR_getMaxValues(_ctx._inst6073);
   max_a = synthFM_ADSR_getMaxValues_ret_0(_ctx._inst6073);
   max_d = synthFM_ADSR_getMaxValues_ret_1(_ctx._inst6073);
   max_s = synthFM_ADSR_getMaxValues_ret_2(_ctx._inst6073);
   max_r = synthFM_ADSR_getMaxValues_ret_3(_ctx._inst6073);
   fix16_t min_a;
   fix16_t min_d;
   fix16_t min_s;
   fix16_t min_r;
   synthFM_ADSR_getMinValues(_ctx._inst61d6);
   min_a = synthFM_ADSR_getMinValues_ret_0(_ctx._inst61d6);
   min_d = synthFM_ADSR_getMinValues_ret_1(_ctx._inst61d6);
   min_s = synthFM_ADSR_getMinValues_ret_2(_ctx._inst61d6);
   min_r = synthFM_ADSR_getMinValues_ret_3(_ctx._inst61d6);
...
void synthFM_ADSR_default(synthFM_ADSR__ctx_type_10 &_ctx){
   ...
   synthFM_ADSR_setLevel(_ctx,0x10000 /* 1.000000 */);
   synthFM_ADSR_setDecimationFactor(_ctx,1);
}
...
fix16_t synthFM_FM_process(synthFM_FM__ctx_type_0 &_ctx, fix16_t (&wavetable_modulator)[4096], fix16_t (&wavetable_carrier)[4096]){
   ...
   _ctx.carrier_env = synthFM_ADSR_process(_ctx.carrieradsr,(_ctx.gate || _ctx.sustaining));
...
void synthFM_FM_process_bufferTo(synthFM_FM__ctx_type_0 &_ctx, fix16_t (&wavetable_modulator)[4096], fix16_t (&wavetable_carrier)[4096], int nb, fix16_t (&oBuffer)[128]){
   ...
   _ctx.env_carrier_idle = synthFM_ADSR_process_bufferTo(_ctx.carrieradsr,(_ctx.gate || _ctx.sustaining),nb,_ctx.buffer_carrier_env);
   _ctx.env_modulator_idle = synthFM_ADSR_process_bufferTo(_ctx.modulatoradsr,(_ctx.gate || _ctx.sustaining),nb,_ctx.buffer_modulator_env);
...
void synthFM_FM_setSamplerate(synthFM_FM__ctx_type_0 &_ctx, fix16_t newFs){
   ...
   synthFM_ADSR_setSamplerate(_ctx.carrieradsr,_ctx.fs);
   synthFM_ADSR_setSamplerate(_ctx.modulatoradsr,_ctx.fs);
}
