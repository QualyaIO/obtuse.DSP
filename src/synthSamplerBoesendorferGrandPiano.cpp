...
void synthSamplerBoesendorferGrandPiano_Voice_default(synthSamplerBoesendorferGrandPiano_Voice__ctx_type_0 &_ctx){
   ...
   synthSamplerBoesendorferGrandPiano_Notes_setIgnoreDuplicates(_ctx.voicesactive,true);
   ...
   synthSamplerBoesendorferGrandPiano_Notes_setIgnoreDuplicates(_ctx.voicesinactive,true);
