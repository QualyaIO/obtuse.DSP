...
void synthDrummer_Drummer_default(synthDrummer_Drummer__ctx_type_0 &_ctx){
   ...
   int kit_slices_start[12];
   {
      ...
      kit_slices_start[3] = 78100;
      kit_slices_start[4] = 22000;
      kit_slices_start[5] = 26000;
      kit_slices_start[6] = 50400;
   ...
   int kit_slices_end[12];
   {
      ...
      kit_slices_end[3] = 83500;
      kit_slices_end[4] = 25500;
      kit_slices_end[5] = 28500;
      kit_slices_end[6] = 60000;
      kit_slices_end[7] = 46500;
      kit_slices_end[8] = 48550;
