...
static_inline int synthFM_Wavetable_noise_wave_samples(){
   return 4096;
};

static_inline fix16_t synthFM_Wavetable_noise_wave(int channel, int index){
   if(channel == 0){
      return fix_wrap_array(synthFM_Wavetable_noise_wave_chan_0)[(index % 4096)];
   }
   return 0x0 /* 0.000000 */;
}
