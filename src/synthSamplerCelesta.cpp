...
uint8_t synthSamplerCelesta_Notes_noteOn(synthSamplerCelesta_Notes__ctx_type_0 &_ctx, int note, int velocity, int channel){
   ...
   if(_ctx.allowDuplicates || isNew){
      if(bool_not(_ctx.poly)){
         if(bool_not(isNew)){
            synthSamplerCelesta_Notes_noteOff(_ctx,note,channel);
         }
         _ctx.nb_notes = (1 + _ctx.nb_notes);
      ...
      {
         int last_note;
         last_note = synthSamplerCelesta_Notes_lastNote(_ctx);
         if(last_note > 0){
...
void synthSamplerCelesta_Sampler__ctx_type_0_init(synthSamplerCelesta_Sampler__ctx_type_0 &_output_){
   ...
   synthSamplerCelesta_Notes__ctx_type_0_init(_ctx.playingnotes);
...
fix16_t synthSamplerCelesta_Sampler_process(synthSamplerCelesta_Sampler__ctx_type_0 &_ctx){
   ...
   if(_ctx.state > 0){
      ...
      else
      {
         ...
         {
            value = fix_mul(_ctx.level,(synthSamplerCelesta_SampleWrapper_getSample(idx) + fix_mul((_ctx.pos % 0x10000 /* 1.000000 */),(synthSamplerCelesta_SampleWrapper_getSample((1 + idx)) + (- synthSamplerCelesta_SampleWrapper_getSample(idx))))));
         }
      }
      if(_ctx.quickKill && ((_ctx.level <= 0x0 /* 0.000000 */) || (_ctx.state <= 0))){
         ...
         _ctx.pos = 0x0 /* 0.000000 */;
         _ctx.state = 1;
         synthSamplerCelesta_Sampler_setNote(_ctx,_ctx.nextNote);
         synthSamplerCelesta_Sampler_setLevel(_ctx,synthSamplerCelesta_Util_velocityToLevel(_ctx.nextVelocity));
      }
   }
   return value;
}
   ...
   while(i < nb){
      if(_ctx.state > 0){
         ...
         else
         {
            ...
            {
               oBuffer[i] = fix_mul(_ctx.level,(synthSamplerCelesta_SampleWrapper_getSample(idx) + fix_mul((_ctx.pos % 0x10000 /* 1.000000 */),(synthSamplerCelesta_SampleWrapper_getSample((1 + idx)) + (- synthSamplerCelesta_SampleWrapper_getSample(idx))))));
            }
         }
         if(_ctx.quickKill && ((_ctx.level <= 0x0 /* 0.000000 */) || (_ctx.state <= 0))){
            _ctx.quickKill = false;
...
void synthSamplerCelesta_Sampler_updateCrossFade(synthSamplerCelesta_Sampler__ctx_type_0 &_ctx){
   if((_ctx.loopS > (256 / 2)) && ((_ctx.size + (- _ctx.loopE)) > (1 + (256 / 2)))){
      ...
      while(i < 256){
         ...
         _ctx.buffer_cross[i] = (fix_mul(k,synthSamplerCelesta_SampleWrapper_getSample((i + idxS))) + fix_mul(synthSamplerCelesta_SampleWrapper_getSample((i + idxE)),(0x10000 /* 1.000000 */ + (- k))));
         i = (1 + i);
      }
   }
   else
...
uint8_t synthSamplerCelesta_Sampler_noteOn(synthSamplerCelesta_Sampler__ctx_type_0 &_ctx, int note, int velocity, int channel){
   note = int_clip(note,0,127);
   uint8_t isNew;
   isNew = synthSamplerCelesta_Notes_noteOn(_ctx.playingnotes,note,velocity,channel);
   _ctx.gate = true;
   if(_ctx.sustain){
      _ctx.sustaining = true;
   }
   ...
   if(synthSamplerCelesta_Notes_noteOff(_ctx.playingnotes,note,channel)){
      if(synthSamplerCelesta_Notes_nbNotes(_ctx.playingnotes) > 0){
         ...
         if((last_played > 0) && (last_played <= 128)){
            ...
            {
               synthSamplerCelesta_Sampler_setNote(_ctx,((-1) + last_played));
            }
         }
      }
      else
...
void synthSamplerCelesta_Sampler_default(synthSamplerCelesta_Sampler__ctx_type_0 &_ctx){
   ...
   if(false){
      ...
      if((lS >= 0) && (lE < _ctx.size) && (lE >= lS)){
         synthSamplerCelesta_Sampler_setLoop(_ctx,true);
         synthSamplerCelesta_Sampler_setLoopStart(_ctx,lS);
         synthSamplerCelesta_Sampler_setLoopEnd(_ctx,lE);
      }
   }
   synthSamplerCelesta_Buffer_buffer(_ctx.buffer_o);
   synthSamplerCelesta_Sampler_setLevel(_ctx,0x10000 /* 1.000000 */);
   synthSamplerCelesta_Sampler_setSamplerate(_ctx,0x2c1999 /* 44.100000 */);
   synthSamplerCelesta_Sampler_setNote(_ctx,69);
   synthSamplerCelesta_Notes_default(_ctx.playingnotes);
   synthSamplerCelesta_Notes_setAllowDuplicates(_ctx.playingnotes,true);
   synthSamplerCelesta_Sampler_setPoly(_ctx,false);
}

void synthSamplerCelesta_Poly__ctx_type_0_init(synthSamplerCelesta_Poly__ctx_type_0 &_output_){
   synthSamplerCelesta_Poly__ctx_type_0 &_ctx = _output_;
   synthSamplerCelesta_Sampler__ctx_type_0_init(_ctx.voice3);
   synthSamplerCelesta_Sampler__ctx_type_0_init(_ctx.voice2);
   synthSamplerCelesta_Sampler__ctx_type_0_init(_ctx.voice1);
   synthSamplerCelesta_Sampler__ctx_type_0_init(_ctx.voice0);
   _ctx.should_leftovers = false;
   synthSamplerCelesta_Poly_default(_ctx);
...
fix16_t synthSamplerCelesta_Poly_getSample(synthSamplerCelesta_Poly__ctx_type_0 &_ctx, int voice){
   switch(voice) {
      case 0:
         return synthSamplerCelesta_Sampler_process(_ctx.voice0);
      break;
      case 1:
         return synthSamplerCelesta_Sampler_process(_ctx.voice1);
      break;
      case 2:
         return synthSamplerCelesta_Sampler_process(_ctx.voice2);
      break;
      case 3:
         return synthSamplerCelesta_Sampler_process(_ctx.voice3);
      break;
...
void synthSamplerCelesta_Poly_default(synthSamplerCelesta_Poly__ctx_type_0 &_ctx){
   _ctx.should_leftovers = false;
   synthSamplerCelesta_Sampler_default(_ctx.voice0);
   synthSamplerCelesta_Sampler_setPoly(_ctx.voice0,true);
   synthSamplerCelesta_Sampler_default(_ctx.voice1);
   synthSamplerCelesta_Sampler_setPoly(_ctx.voice1,true);
   synthSamplerCelesta_Sampler_default(_ctx.voice2);
   synthSamplerCelesta_Sampler_setPoly(_ctx.voice2,true);
   synthSamplerCelesta_Sampler_default(_ctx.voice3);
   synthSamplerCelesta_Sampler_setPoly(_ctx.voice3,true);
}

void synthSamplerCelesta_Voice__ctx_type_0_init(synthSamplerCelesta_Voice__ctx_type_0 &_output_){
   synthSamplerCelesta_Voice__ctx_type_0 &_ctx = _output_;
   synthSamplerCelesta_Notes__ctx_type_0_init(_ctx.voicesinactive);
   synthSamplerCelesta_Notes__ctx_type_0_init(_ctx.voicesactive);
   _ctx.voices_ratio = 0x0 /* 0.000000 */;
   int_init_array(4,0,_ctx.voices);
   synthSamplerCelesta_Notes__ctx_type_0_init(_ctx.voiceinsactive);
   _ctx.reuse = false;
   synthSamplerCelesta_Poly__ctx_type_0_init(_ctx.poly);
...
fix16_t synthSamplerCelesta_Voice_process(synthSamplerCelesta_Voice__ctx_type_0 &_ctx){
   ...
   while(i < _ctx.number_voices){
      _ctx.last_values[i] = synthSamplerCelesta_Poly_getSample(_ctx.poly,i);
...
void synthSamplerCelesta_Voice_process_bufferTo(synthSamplerCelesta_Voice__ctx_type_0 &_ctx, int nb, fix16_t (&oBuffer)[128]){
   ...
   if(v < _ctx.number_voices){
      synthSamplerCelesta_Poly_runVoice(_ctx.poly,v,nb,_ctx.buffer_v0);
      i = 0;
      while(i < nb){
...
void synthSamplerCelesta_Voice_process_bufferTo_alt(synthSamplerCelesta_Voice__ctx_type_0 &_ctx, int nb, fix16_t (&oBuffer)[128]){
   nb = int_clip(nb,0,128);
   if(nb == 0){
      nb = 128;
   }
...
void synthSamplerCelesta_Voice_noteOff(synthSamplerCelesta_Voice__ctx_type_0 &_ctx, int note, int channel){
   ...
   v = _ctx.notes[note];
   if((v > 0) && (v <= 4)){
      if(synthSamplerCelesta_Notes_noteOff(_ctx.voicesactive,((-1) + v),0)){
         synthSamplerCelesta_Poly_sendNoteOff(_ctx.poly,((-1) + v),note,channel);
         _ctx.notes[note] = (- v);
         _ctx.voices[((-1) + v)] = (- (1 + note));
         if(v <= _ctx.number_voices){
            synthSamplerCelesta_Notes_noteOn(_ctx.voicesinactive,((-1) + v),127,0);
         }
      }
   }
}
...
void synthSamplerCelesta_Voice_noteOn(synthSamplerCelesta_Voice__ctx_type_0 &_ctx, int note, int velocity, int channel){
   ...
   if((v > 0) && (v <= _ctx.number_voices)){
      if(bool_not((synthSamplerCelesta_Notes_noteOff(_ctx.voicesactive,((-1) + v),0) && synthSamplerCelesta_Notes_noteOn(_ctx.voicesinactive,((-1) + v),127,0) && synthSamplerCelesta_Notes_noteOff(_ctx.voicesinactive,((-1) + v),0) && synthSamplerCelesta_Notes_noteOn(_ctx.voicesactive,((-1) + v),127,0)))){
         _ctx.notes[note] = 0;
         _ctx.voices[((-1) + v)] = 0;
         v = 0;
      }
   ...
   else
   {
      if(_ctx.reuse && (v < 0) && ((- v) <= _ctx.number_voices) && (_ctx.voices[((-1) + (- v))] == (- (1 + note))) && (_ctx.notes[note] == v)){
         v = (- v);
         if(bool_not((synthSamplerCelesta_Notes_noteOff(_ctx.voicesinactive,((-1) + v),0) && synthSamplerCelesta_Notes_noteOn(_ctx.voicesactive,((-1) + v),127,0)))){
            _ctx.notes[note] = 0;
            _ctx.voices[((-1) + v)] = 0;
            v = 0;
         }
      ...
      {
         v = synthSamplerCelesta_Notes_firstNote(_ctx.voicesinactive);
         if((v <= 0) || (v > _ctx.number_voices)){
            int active_v;
            active_v = synthSamplerCelesta_Notes_firstNote(_ctx.voicesactive);
            if(active_v > 0){
               synthSamplerCelesta_Voice_noteOff(_ctx,_ctx.voices[((-1) + active_v)],0);
            }
         }
         v = synthSamplerCelesta_Notes_firstNote(_ctx.voicesinactive);
         if((v > 0) && (v <= _ctx.number_voices)){
   ...
   if(v > 0){
      if(synthSamplerCelesta_Poly_shouldLeftOvers(_ctx.poly)){
         _ctx.leftovers = (_ctx.leftovers + _ctx.last_values[((-1) + v)]);
      }
      synthSamplerCelesta_Poly_sendNoteOn(_ctx.poly,((-1) + v),note,velocity,channel);
      _ctx.notes[note] = v;
...
void synthSamplerCelesta_Voice_setNbVoices(synthSamplerCelesta_Voice__ctx_type_0 &_ctx, int nbvoices){
   ...
   i = synthSamplerCelesta_Notes_nbNotes(_ctx.voicesinactive);
   if(i < nbvoices){
      while(i < nbvoices){
         synthSamplerCelesta_Notes_noteOn(_ctx.voicesinactive,i,127,0);
         i = (1 + i);
      }
   }
   else
   {
      while(i >= nbvoices){
         synthSamplerCelesta_Notes_noteOff(_ctx.voicesinactive,i,0);
         i = ((-1) + i);
      }
   }
...
void synthSamplerCelesta_Voice_setSamplerate(synthSamplerCelesta_Voice__ctx_type_0 &_ctx, fix16_t newFs){
   ...
   synthSamplerCelesta_Poly_setSamplerate(_ctx.poly,_ctx.fs);
   fix16_t log_base;
...
void synthSamplerCelesta_Voice_default(synthSamplerCelesta_Voice__ctx_type_0 &_ctx){
   ...
   synthSamplerCelesta_Voice_setNbVoices(_ctx,_ctx.number_voices);
   synthSamplerCelesta_Notes_default(_ctx.voicesactive);
   synthSamplerCelesta_Notes_setPoly(_ctx.voicesactive,false);
   synthSamplerCelesta_Notes_setAllowDuplicates(_ctx.voicesactive,false);
   synthSamplerCelesta_Notes_default(_ctx.voicesinactive);
   synthSamplerCelesta_Notes_setPoly(_ctx.voicesinactive,false);
   synthSamplerCelesta_Notes_setAllowDuplicates(_ctx.voiceinsactive,false);
