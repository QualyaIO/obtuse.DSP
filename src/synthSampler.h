...
static_inline fix16_t synthSampler_Util_tonesToCoeff(fix16_t semitones){
   fix16_t log_base;
   log_base = 0xb172 /* 0.693147 */;
   return fix_exp(fix_mul(fix_mul(0x1555 /* 0.083333 */,log_base),semitones));
}

typedef struct synthSampler_Util__ctx_type_2 {
   uint8_t pre;
} synthSampler_Util__ctx_type_2;

typedef synthSampler_Util__ctx_type_2 synthSampler_Util_edge_type;

static_inline void synthSampler_Util__ctx_type_2_init(synthSampler_Util__ctx_type_2 &_output_){
   synthSampler_Util__ctx_type_2 &_ctx = _output_;
   _ctx.pre = false;
   
   return ;
}

static_inline void synthSampler_Util_edge_init(synthSampler_Util__ctx_type_2 &_output_){
   synthSampler_Util__ctx_type_2_init(_output_);
   return ;
}

static_inline uint8_t synthSampler_Util_edge(synthSampler_Util__ctx_type_2 &_ctx, uint8_t x){
   uint8_t ret;
...
typedef synthSampler_Util__ctx_type_4 synthSampler_Util_change_type;
...
static_inline void synthSampler_Util_change_init(synthSampler_Util__ctx_type_4 &_output_){
   synthSampler_Util__ctx_type_4_init(_output_);
   return ;
}

static_inline uint8_t synthSampler_Util_change(synthSampler_Util__ctx_type_4 &_ctx, fix16_t x){
   uint8_t v;
   v = (_ctx.pre_x != x);
   _ctx.pre_x = x;
   return v;
...
typedef struct synthSampler_Util__ctx_type_5 {
   fix16_t x;
} synthSampler_Util__ctx_type_5;

typedef synthSampler_Util__ctx_type_5 synthSampler_Util_smooth_type;

static_inline void synthSampler_Util__ctx_type_5_init(synthSampler_Util__ctx_type_5 &_output_){
   synthSampler_Util__ctx_type_5 &_ctx = _output_;
   _ctx.x = 0x0 /* 0.000000 */;
   
   return ;
}

static_inline void synthSampler_Util_smooth_init(synthSampler_Util__ctx_type_5 &_output_){
   synthSampler_Util__ctx_type_5_init(_output_);
   return ;
}

static_inline fix16_t synthSampler_Util_smooth(synthSampler_Util__ctx_type_5 &_ctx, fix16_t input, fix16_t coeff){
...
static_inline void synthSampler_Notes_setAllowDuplicates(synthSampler_Notes__ctx_type_0 &_ctx, uint8_t flag){
...
static_inline void synthSampler_Notes_default(synthSampler_Notes__ctx_type_0 &_ctx){
   ...
   synthSampler_Notes_setAllowDuplicates(_ctx,false);
}
...
static_inline void synthSampler_Buffer_buffer(fix16_t (&oBuff)[128]){
}

void synthSampler_Buffer_buffer_large(fix16_t (&oBuff)[2048]);

static_inline int synthSampler_Buffer_bufferSize(){
   return 128;
};

static_inline int synthSampler_Buffer_bufferLargeSize(){
   return 2048;
};
...
static_inline void synthSampler_Sampler_updateStep(synthSampler_Sampler__ctx_type_0 &_ctx){
   ...
   if(_ctx.bend != 0x0 /* 0.000000 */){
      _ctx.step = fix_mul(_ctx.step,synthSampler_Util_tonesToCoeff(_ctx.bend));
   }
}

typedef synthSampler_Sampler__ctx_type_0 synthSampler_Sampler_pitchBend_type;

static_inline void synthSampler_Sampler_pitchBend_init(synthSampler_Sampler__ctx_type_0 &_output_){
   synthSampler_Sampler__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthSampler_Sampler_pitchBend(synthSampler_Sampler__ctx_type_0 &_ctx, fix16_t semitones){
...
void synthSampler_Sampler_process_bufferTo(synthSampler_Sampler__ctx_type_0 &_ctx, int nb, fix16_t (&oBuffer)[128]);
...
typedef synthSampler_Sampler__ctx_type_0 synthSampler_Sampler_nbHeldNotes_type;

static_inline void synthSampler_Sampler_nbHeldNotes_init(synthSampler_Sampler__ctx_type_0 &_output_){
   synthSampler_Sampler__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthSampler_Sampler_nbHeldNotes(synthSampler_Sampler__ctx_type_0 &_ctx){
   return synthSampler_Notes_nbNotes(_ctx.playingnotes);
};
...
uint8_t synthSampler_Sampler_noteOn(synthSampler_Sampler__ctx_type_0 &_ctx, int note, int velocity, int channel);
...
static_inline void synthSampler_Sampler__ctx_type_1_init(synthSampler_Sampler__ctx_type_1 &_output_){
   synthSampler_Sampler__ctx_type_1 &_ctx = _output_;
...
static_inline void synthSampler_Poly_runVoice(synthSampler_Poly__ctx_type_0 &_ctx, int voice, int nb, fix16_t (&buff)[128]){
   switch(voice) {
      case 0:
...
typedef synthSampler_Poly__ctx_type_0 synthSampler_Poly_synthPitchBend_type;

static_inline void synthSampler_Poly_synthPitchBend_init(synthSampler_Poly__ctx_type_0 &_output_){
   synthSampler_Poly__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthSampler_Poly_synthPitchBend(synthSampler_Poly__ctx_type_0 &_ctx, fix16_t semitones){
   synthSampler_Sampler_pitchBend(_ctx.voice0,semitones);
   synthSampler_Sampler_pitchBend(_ctx.voice1,semitones);
   synthSampler_Sampler_pitchBend(_ctx.voice2,semitones);
   synthSampler_Sampler_pitchBend(_ctx.voice3,semitones);
}
...
typedef struct synthSampler_Voice__ctx_type_0 {
   ...
   int voices[4];
   synthSampler_Notes__ctx_type_0 voiceinsactive;
   uint8_t reuse;
...
void synthSampler_Voice_process_bufferTo(synthSampler_Voice__ctx_type_0 &_ctx, int nb, fix16_t (&oBuffer)[128]);

typedef synthSampler_Voice__ctx_type_0 synthSampler_Voice_setReuse_type;

static_inline void synthSampler_Voice_setReuse_init(synthSampler_Voice__ctx_type_0 &_output_){
   synthSampler_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthSampler_Voice_setReuse(synthSampler_Voice__ctx_type_0 &_ctx, uint8_t flag){
   _ctx.reuse = flag;
};
...
typedef synthSampler_Voice__ctx_type_0 synthSampler_Voice_nbActiveVoices_type;

static_inline void synthSampler_Voice_nbActiveVoices_init(synthSampler_Voice__ctx_type_0 &_output_){
   synthSampler_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline int synthSampler_Voice_nbActiveVoices(synthSampler_Voice__ctx_type_0 &_ctx){
   return synthSampler_Notes_nbNotes(_ctx.voicesactive);
};
...
typedef synthSampler_Voice__ctx_type_0 synthSampler_Voice_synthPitchBend_type;

static_inline void synthSampler_Voice_synthPitchBend_init(synthSampler_Voice__ctx_type_0 &_output_){
   synthSampler_Voice__ctx_type_0_init(_output_);
   return ;
}

static_inline void synthSampler_Voice_synthPitchBend(synthSampler_Voice__ctx_type_0 &_ctx, fix16_t semitones){
   synthSampler_Poly_synthPitchBend(_ctx.poly,semitones);
};
...
static_inline void synthSampler_Voice__ctx_type_1_init(synthSampler_Voice__ctx_type_1 &_output_){
